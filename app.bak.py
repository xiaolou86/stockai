...
def high():
    if request.method == 'POST':
        try:
            ...
            daily_df=ak.stock_zh_a_daily(symbol='sh600751', start_date="20241022", end_date="20251230")
            #print(daily)
            ...
            for i in range(daily_len):
                ...
                rate = (high_price-open_price)/open_price
                ...
                dates_datas[dates[i]]["open"] = opens[i]
                dates_datas[dates[i]]["high"] = highs_daily[i]

                dates_datas[dates[i]]["range_start"] = open_price * (1+rate_low)
                dates_datas[dates[i]]["range_end"] = open_price * (1+rate_high)
            ...
            return render_template('high.html', highest_ranks=highest_ranks)
        except ValueError:
